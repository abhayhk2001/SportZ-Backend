...
urlpatterns = [
	...
	# Admin and Faculty
	path('sportteaminfo',commonviews.sportTeamInfo, name="Sport Team Information"),


	# Faculty
	path('faculty/login',facultyviews.login, name="Faculty Login"),
	path('faculty/studentinfo',facultyviews.facultyStudentInfo, name="Faculty Student Information"),
	path('faculty/facultyinfo',facultyviews.facultyInfo, name="Faculty Information"),


	# Student
	path('student/login',studentviews.login, name="Student Login"),
	path('student/studentinfo',studentviews.studentInfo, name="Student Information"),
	path('student/sportteaminfo',studentviews.studentSportTeamInfo, name="Student Sport Team Information"),
	

	# Common
	path('matchinfo',commonviews.matchInfo, name="Match Information"),
	path('eventinfo',commonviews.eventInfo, name="Event Information"),
	path('sporteventinfo',commonviews.sportEventInfo, name="Sport Event Information"),
